        ...
        <Card>
          <CardHeader plain color="primary">
            ...
            <p className={classes.cardCategoryWhite}>
              samsung venture project, searching and rescuing missing person
            </p>
          </CardHeader>
          <CardBody>
            <p className={classes.description} style={{fontSize:"1.5rem"}}>
              A system that helps rescue teams to find the missing person in a mountainous environment
            </p>
